...
PUBLIC_FRONTEND_URL="${PUBLIC_FRONTEND_URL:-$FRONTEND_URL}"
PUBLIC_BASE_URL="${PUBLIC_BASE_URL:-$BASE_URL}"
PUBLIC_PROMETHEUS_URL="${PUBLIC_PROMETHEUS_URL:-$PROMETHEUS_URL}"
PUBLIC_GRAFANA_URL="${PUBLIC_GRAFANA_URL:-$GRAFANA_URL}"
STARTED_AT="$(date +%s)"
